...
void Application::initControllers() {
    ...
    QObject::connect(mainWind, &MainWindow::CreateNewProject, mwc, &MainWindController::onCreateProject); // Create project
    ...
    QObject::connect(mainWind, &MainWindow::CloseProject, mwc, &MainWindController::onCloseProject); // Open file
