...
void CloseDialog::mousePressEvent(QMouseEvent* event) { // Press
...
void CloseDialog::mouseMoveEvent(QMouseEvent* event) { // Moving
    if (mousePressed) {
...
void CloseDialog::mouseReleaseEvent(QMouseEvent* event) { // release
    if (event->button() == Qt::LeftButton) {
