...
CustomWindowWarning::CustomWindowWarning(const QString& message, QWidget* parent) : QWidget(parent) {
    ...
    QTimer::singleShot(2000, this, &CustomWindowWarning::close);
}


void CustomWindowWarning::updatePosition(QWidget* parent) {
    if (parent) {
...
void CustomWindowWarning::showEvent(QShowEvent* event) {
