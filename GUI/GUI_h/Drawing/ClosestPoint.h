...
public:
    ...
    [[maybe_unused]]
    static QVector<ID> enteringInRect(std::unordered_map<ID, Point*>& points, QRectF& rect, QVector<ID>&);

    [[maybe_unused]]
    static QVector<ID> enteringInRect(std::unordered_map<ID, Section*>& sections, QRectF& rect, QVector<ID>&);

    [[maybe_unused]]
    static QVector<ID> enteringInRect(std::unordered_map<ID, Circle*>& circles, QRectF& rect, QVector<ID>&);

    [[maybe_unused]]
    static QVector<ID> enteringInRect(std::unordered_map<ID, Arc*>& arcs, QRectF& rect, QVector<ID>&);
